...
label_translation_dict = {
    ...
    'very_low_mf_own_bldg_cnt': 'VL$ multi-family Suitable',
    ...
    'renew_prod': 'State_Renewable_Energy_%',
...
class Data_set_paths:
    ...
    DS_NREL_SVI_paths = [
        r'C:\Users\gjone\DeepLearningDeepSolar\_Data\DeepSolar\deepsolar_tract_orig_Adoption.csv',
        r'C:\Users\gjone\DeepLearningDeepSolar\_Data\NREL\NREL_seeds_all.csv',
    ]
...
class Main_Usecols:
    ...
    def process_request(self):
        ...
        elif self.model.lower() == 'MIX'.lower():
            return self.get_deepsolar() + self.get_nrel()
        else:
            print('Unknown data set {}'.format(self.model))
            print('options are: DS and NREL')
            quit(-99)

def GetMainCols(model):
    return Main_Usecols(model).use_cols
